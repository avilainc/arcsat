...
from routers import customers, deals, activities, contacts, cnpj, cep, customer_extras, analytics, automation, pipeline, reports, import_data, email, notifications, tasks
